...
class EnumSemanticFallbackRuleTest {
    ...
    private static ConsumerDefinition consumer(String name, String body) {
        String source = """
                ...
                """.formatted(body);
        return new ConsumerDefinition(name, null, "com.example.orders.OrderEvent", ConsumerSourceType.BUILT_IN_SAMPLE, null, "test-revision",
    ...
    class Positive {
        ...
        void reportsNestedEnumPath() {
            ...
            ConsumerDefinition warehouse = new ConsumerDefinition("warehouse", null,
                    "com.example.orders.OrderEvent", ConsumerSourceType.BUILT_IN_SAMPLE, null, "test-revision",
